  ...
  return (
    <div className="pt-16">
      ...
      <article className="font-[300] text-2xl leading-[3.5rem] px-8 md:px-20 lg:px-[12.5%] md:text-4xl lg:text-6xl xl:text-7xl lg:lead-[5rem] xl:leading-[8rem] my-16 lg:mt-28">
        ...
        <a href="" className="font-[400] underline underline-offset-4">
          telegram
        </a>
      ...
      <div className="flex justify-center font-[300] text-2xl leading-[3.5rem] px-8 md:px-20 lg:px-[12.5%] md:text-4xl lg:text-6xl xl:text-7xl lg:lead-[5rem] xl:leading-[8rem] lg:mt-16 lg:mt-28 pb-28 lg:pb-52">
