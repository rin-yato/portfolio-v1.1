...
function me() {
  return (
    <div className="pt-16" data-scroll-section>
      <h1 data-scroll className="font-[300] text-2xl leading-[3.5rem] px-8 md:px-20 lg:px-[12.5%] md:text-4xl lg:text-6xl xl:text-7xl lg:lead-[5rem] xl:leading-[8rem] my-16 lg:mt-28">
        Ohh? So, you want to know more about me?
      </h1>
      <article data-scroll className="font-[300] text-2xl leading-[3.5rem] px-8 md:px-20 lg:px-[12.5%] md:text-4xl lg:text-6xl xl:text-7xl lg:lead-[5rem] xl:leading-[8rem] my-16 lg:mt-28">
      ...
      <article data-scroll className="font-[300] text-2xl leading-[3.5rem] px-8 md:px-20 lg:px-[12.5%] md:text-4xl lg:text-6xl xl:text-7xl lg:lead-[5rem] xl:leading-[8rem] mt-16 lg:mt-28 pb-28">
        Alright! Take care and have a nice day!
      </article>
      <div data-scroll className="flex justify-center font-[300] text-2xl leading-[3.5rem] px-8 md:px-20 lg:px-[12.5%] md:text-4xl lg:text-6xl xl:text-7xl lg:lead-[5rem] xl:leading-[8rem] lg:mt-28 pb-28 lg:pb-52">
